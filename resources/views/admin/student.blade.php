                ...
                <div class="col-12">
                    <div class="box">
                        <div class="box-header with-border d-flex justify-content-between align-items-center">
                            ...
                            <a href="#" class="fs-5" style="color: #082D33; text-decoration: none;">Add Student <i class="fi fi-rr-add"></i></a> <!-- Aligning Data Sekolah and Add Sekolah in one line -->
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
